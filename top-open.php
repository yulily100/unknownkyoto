  ...
  <div class="wrapper">
    <ul class="top-open-contents">
      ...
      <li class="top-open-body">
        ...
        17:00 - <span class="limited">22:00 (L.O. 21:00)</span><br>
        <span class="top-open-contents-note">日曜定休、平常夜は23時まで</span>
        </p>
      </li>
      <li class="top-open-body">
        <h3 class="top-open-contents-title">
        ...
        <p class="top-open-contents-description">DROP IN…10:00 - <span class="limited">17:00</span><br>
        <span class="top-open-contents-note">一時的にスタッフ不在のため<br>事前にご予約ください</span>
      </p>
      </li>
    </ul>
  </div>
