  ...
  <div class="wrapper">
    <ul class="top-open-contents">
      <li class="top-open-heading">
        ...
        <p class="top-open-note">行政からの要請によりレストランの営業時間を一部変更しています。</p>
      ...
      <li class="top-open-body">
        ...
        <p class="top-open-contents-description">11:30 - 15:00 (L.O. 14:30)<br>夜は一時休業中<!-- 17:00 - <span class="limited">21:00</span>--><br>
      ...
      <li class="top-open-body">
        ...
        <span class="top-open-contents-note">ドロップインは日曜定休</span>
      </p>
      </li>
    </ul>
  </div>
