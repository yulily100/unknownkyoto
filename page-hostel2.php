...
<div class="hostel2-intro">
  ...
  <div class="hostel2-intro-text">
    ...
    ホテルのような重厚な設備はございませんが、<br>
    古い木造建物ならではの息づかいをお楽しみください。</p>
    <p class="hostel2-intro-description">宿泊のお客様はチェックインの朝からチェックアウトの夜まで<br>追加料金なしでコワーキングがご利用いただけます。</p>
...
<div class="hostel2-room">
  <section class="hostel2-room-private">
    <div class="hostel2-room-private-text">
      ...
      <p class="hostel2-room-price"><span class="line-through">7,500円</span><br>GO TOトラベル価格で4,880円 + 地域共通クーポン1000円分配布</p>
    </div>
  ...
  <section class="hostel2-room-private">
    <div class="hostel2-room-private-text">
      ...
      <p class="hostel2-room-price"><span class="line-through">8,500円</span><br>GO TOトラベル価格で5,530円 + 地域共通クーポン1000円分配布</p>
    </div>
    <div class="hostel2-room-private-img">
      <ul class="hostel2-gallery">
  ...
  <section class="hostel2-room-private">
    <div class="hostel2-room-private-text">
      ...
      <p class="hostel2-room-price"><span class="line-through">9,000円</span><br>GO TOトラベル価格で5,850円 + 地域共通クーポン1000円分配布</p>
    </div>
    <div class="hostel2-room-private-img">
      <ul class="hostel2-gallery">
  ...
  <section class="hostel2-room-private">
    <div class="hostel2-room-private-text">
      ...
      <p class="hostel2-room-price"><span class="line-through">10,500円</span><br>GO TOトラベル価格で6,830円 + 地域共通クーポン2000円分配布</p>
    </div>
    <div class="hostel2-room-private-img">
      <ul class="hostel2-gallery">
  ...
  <div class="hostel2-room-dormitory">
    <div class="hostel2-room-dormitory-contents">
      ...
      <p class="hostel2-room-price"><span class="line-through">3,500円</span><br>GO TOトラベル価格で2,280円 + 地域共通クーポン1000円分配布</p>
    </div>
    <div class="hostel2-room-dormitory-contents">
      ...
      <p class="hostel2-room-note">タオルはこちらのお部屋にはついておりません。ご持参いただくか、レンタルをご用意しておりますのでご利用ください。</p>
      <p class="hostel2-room-price"><span class="line-through">4,000円</span><br>GO TOトラベル価格で2,600円 + 地域共通クーポン1000円分配布</p>
    </div>
  </div>
  <div class="hostel2-longterm">
    <h3 class="hostel2-longterm-title">泊まるほどお得に</h3>
    <p>3泊以上ご宿泊で宿泊料金の20%オフいたします。<br>
      6泊以上はウィークリープラン、13泊以上は2週間プラン、27泊以上はマンスリープランがあり、長ければ長いほどお得にお泊りいただけます。</p>
    <p>詳しくはプランをご覧ください</p>
  </div>
...
<div class="hostel2-facilities-contents reverse">
  ...
  <div class="hostel2-facilities-contents-text">
    <div class="hostel2-facilities-contents-left">
      ...
      <p class="hostel2-facilities-contents-description">宿泊のお客様はチェックイン日の朝から、チェックアウト日の夜まで、追加料金なしでご利用いただけます。</p>
      <p class="hostel2-facilities-contents-link"><a href="">詳しくはこちら</a></p>
    </div>
  </div>
</div>
...
<div class="hostel2-facirities-amenities">
  <h3 class="hostel2-facirities-amenities-title"><span>アメニティ</span>Amenity</h3>
  <ul class="hostel2-facirities-amenities-contents">
    <li>スリッパ<span>100円</span></li>
    <li>耳栓<span>100円</span></li>
    <li>カミソリ<span>50円</span></li>
    <li>歯ブラシ<span>50円</span></li>
    <li>レンタルバスタオル<span>200円</span></li>
    <li>レンタルフェイスタオル<span>150円</span></li>
  </ul>
</div>


<div class="wrapper">
<div class="hostel2-plan">
