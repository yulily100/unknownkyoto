    ...
    <ul class="index-rooms js-fadein">
      <li>
        ...
        <div class="index-rooms-text">
          ...
          <p>1泊 <?php echo hotel_price('single1'); ?>円〜<br>4泊 <?php echo hotel_price('single4') ?>円</p>
      ...
      <li>
        ...
        <div class="index-rooms-text">
          ...
          <p>1泊 <?php echo hotel_price('relax1') ?>円〜<br>4泊 <?php echo hotel_price('relax4') ?>円</p>
          <p class="index-rooms-detail"><a href="/hostel">詳しく見る</a></p>
        </div>
      </li>
      <li>
        ...
        <div class="index-rooms-text">
          ...
          <p>1泊 <?php echo hotel_price('double1') ?>円〜（2名でも同価格）<br>4泊 <?php echo hotel_price('double4') ?>円</p>
          <p class="index-rooms-detail"><a href="/hostel">詳しく見る</a></p>
        </div>
      </li>
      <li>
        ...
        <div class="index-rooms-text">
          ...
          <p>1泊 <?php echo hotel_price('deluxe1') ?>円〜（2名でも同価格）<br>4泊 <?php echo hotel_price('deluxe4') ?>円</p>
          <p class="index-rooms-detail"><a href="/hostel">詳しく見る</a></p>
        </div>
      </li>
  ...
  <div class="index-dormitory js-fadein">
    ...
    <div class="index-dormitory-contents">
      ...
      <div class="index-dormitory-text">
        ...
        <p class="index-rooms-price">男女混合・女性専用ともに<br>1泊 <?php echo hotel_price('dormitory1') ?>円<br>4泊 <?php echo hotel_price('dormitory4') ?>円</p>
        <p class="index-rooms-detail"><a href="/hostel">詳しく見る</a></p>
      </div>
    </div>
  </div>
